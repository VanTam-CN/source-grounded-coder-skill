...
6. **Report faithfully**: say what changed, what was verified, and what could not be verified. Never claim success that the evidence does not support. If the task exposed a gap in this skill's guidance, note it for the evolution log.
